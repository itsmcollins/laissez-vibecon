...
**URL Structure:**
- Preview: `https://link-guard-fix.preview.emergentagent.com` (or similar)
- Your domain: `https://link-guard-fix.preview.emergentagent.com`

**Architecture:**
```
Browser Request → https://link-guard-fix.preview.emergentagent.com/api/agents
                                                            ↓
...
- Preview: `https://link-guard-fix.preview.emergentagent.com` → Same domain `/api/*`
...
1. **Access your preview URL:**
   ```
   https://link-guard-fix.preview.emergentagent.com
   ```
