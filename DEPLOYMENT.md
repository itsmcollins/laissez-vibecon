...
**URL Structure:**
- Preview: `https://telepriv.preview.emergentagent.com` (or similar)
- Your domain: `https://telepriv.preview.emergentagent.com`

**Architecture:**
```
Browser Request → https://telepriv.preview.emergentagent.com/api/agents
                                                            ↓
...
- Preview: `https://telepriv.preview.emergentagent.com` → Same domain `/api/*`
...
1. **Access your preview URL:**
   ```
   https://telepriv.preview.emergentagent.com
   ```
