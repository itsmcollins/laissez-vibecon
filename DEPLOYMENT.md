...
**URL Structure:**
- Preview: `https://proxy-bot-service.preview.emergentagent.com` (or similar)
- Your domain: `https://proxy-bot-service.preview.emergentagent.com`

**Architecture:**
```
Browser Request → https://proxy-bot-service.preview.emergentagent.com/api/agents
                                                            ↓
...
- Preview: `https://proxy-bot-service.preview.emergentagent.com` → Same domain `/api/*`
...
1. **Access your preview URL:**
   ```
   https://proxy-bot-service.preview.emergentagent.com
   ```
